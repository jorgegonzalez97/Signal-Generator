...
function [Xs, Xw, Xc,Y,lbl]=signal_generator_2d(SNR,iteraciones,T,rTipoSig,BWc,T1_rel,Tcesc,Dfesc,vsFSK,Dffsk,nFSK,vsPSK,nPSK,pAl,cAl,cod,vsASK,vsQAM,Roff)
...
%   Y -> mod, SNR, params:
         ...
         s = I + 1j*Q;
         S1 = tfrstft(s.',1:16:length(s), length(s)/16);
